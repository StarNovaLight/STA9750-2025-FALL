...
max_trees
```
### County Disttrict  [`r max_trees$CounDist`]{style='color:cyan;'} have the highest amount of trees which was  [`r max_trees$total_number_of_trees`]{style='color:cyan;'}.
```{r}
#|cache: true
...
nearest_tree
```
### The nearest tree to Baruch College is  [`r nearest_tree$genusspecies`]{style='color:cyan;'}.
